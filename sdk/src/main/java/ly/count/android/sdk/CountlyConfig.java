...
public class CountlyConfig {
    ...
    /**
     * enum value specifying which device ID generation strategy Countly should use: OPEN_UDID or SDK_GENERATED.
     * SDK_GENERATED is a random UUID generated by the SDK.
     * Default is OPEN_UDID.
     *
     * @return Returns the same config object for convenient linking
     */
