...
public class CountlyPush {
    public static final String EXTRA_ACTION_INDEX = "ly.count.sdk.android.CountlyPush.Action";
    public static final String EXTRA_MESSAGE = "ly.count.sdk.android.CountlyPush.message";
    ...
    public interface Message extends Parcelable {
         ...
         *
         * @param context Ctx to record action in
         */
     ...
     * Also available as {@link ly.count.sdk.android.internal.Device#isAppRunningInForeground(Context)}
     *
