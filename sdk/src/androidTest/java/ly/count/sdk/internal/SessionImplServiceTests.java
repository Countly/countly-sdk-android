...
public class SessionImplServiceTests extends BaseTests {
    ...
    public void setUp() throws Exception {
        ...
        } else if (testName.getMethodName().contains("session_crashRecorded")){
    ...
    public void constructor_empty(){
        ...
        long time = Device.dev.uniqueTimestamp();
    ...
    public void beginEndSession_doubleBegin() throws Exception {
        setUpService(null);//use a service for the least flexible situation
    ...
    @Test
    public void beginEndSession_valuesCorrect() throws Exception {
        setUpService(null);//use a service for the least flexible situation
    ...
    @Test
    public void beginEndSession_simple() throws Exception {
        setUpService(null);//use a service for the least flexible situation
    ...
    @Test
    public void getBeganAndEnded() throws Exception {
        setUpService(null);//use a service for the least flexible situation
    ...
    @Test
    public void beginEndSession_simpleWithWait() throws Exception {
        setUpService(null);//use a service for the least flexible situation
    ...
    @Test
    public void storeRestore_full() throws Exception {
        setUpService(null);//use a service for the least flexible situation
    ...
    @Test
    public void session_lifecycle() throws Exception {
        setUpService(null);//use a service for the least flexible situation
    ...
    public void session_recoverNoUpdate() throws Exception {
        ...
        long beginNs = System.nanoTime() - Device.dev.secToNs(config.getSessionCooldownPeriod() * 3);
        SessionImpl session = new SessionImpl(ctx, System.currentTimeMillis() - Device.dev.secToNs(config.getSessionCooldownPeriod() * 3));
    ...
    public void session_recoverWithUpdate() throws Exception {
        ...
        long beginNs = System.nanoTime() - Device.dev.secToNs(config.getSessionCooldownPeriod() * 3);
        SessionImpl session = new SessionImpl(ctx, System.currentTimeMillis() - Device.dev.secToMs(config.getSessionCooldownPeriod() * 3));
        session.begin(beginNs);
        session.update(System.nanoTime() - Device.dev.secToNs(config.getSessionCooldownPeriod() * 2));
    ...
    public void session_recoversNothingWithEnd() throws Exception {
        ...
        session.update(System.nanoTime() - Device.dev.secToNs(10));
        session.end();
