...
public class scAP_AppPerfomanceMonit {
    ...
    CountlyConfig createAPMConfig() {
        CountlyConfig config = new CountlyConfig(TestUtils.getContext(), TestUtils.commonAppKey, TestUtils.commonURL).setDeviceId(TestUtils.commonDeviceId).setLoggingEnabled(true);
