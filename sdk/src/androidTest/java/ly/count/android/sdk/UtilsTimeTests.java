...
public class UtilsTimeTests {
    ...
    public void testDiff() throws InterruptedException {
        ...
        // because current timestamp is generated by timeGenerator.uniqueTimestamp()
        // which provides a unique timestamp every time it is called
        Thread.sleep(250);

        long tms2 = UtilsTime.currentTimestampMs();

        // so it sometimes exceeds 260ms
